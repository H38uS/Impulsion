...
class Zend_Controller_Plugin_ErrorHandler extends Zend_Controller_Plugin_Abstract {
    ...
    /**
     * Const - Unexpected value of a parameter
     */
    const EXCEPTION_UNEXPECTED_VALUE = 'EXCEPTION_UNEXPECTED_VALUE';

    /**
     * Const - Exception raised during email sending
     */
    const EXCEPTION_MAIL_TRANSPORT = 'EXCEPTION_MAIL_TRANSPORT';
        ...
        if (($response->isException()) && (!$this->_isInsideErrorHandlerLoop)) {
            ...
            switch ($exceptionType) {
                ...
                case 'Zend_Controller_Action_Exception':
                    ...
                    break;
                case 'My_Exception_UnexpectedValue':
                    $error->type = self::EXCEPTION_UNEXPECTED_VALUE;
                    break;
                case 'Zend_Mail_Transport_Exception':
                    $error->type = self::EXCEPTION_MAIL_TRANSPORT;
                    break;
                default:
                    $error->type = self::EXCEPTION_OTHER;
                    break;
