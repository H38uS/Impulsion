    ...
    public function errorAction() {
        ...
        switch ($errors->type) {
            ...
            case Zend_Controller_Plugin_ErrorHandler::EXCEPTION_NO_ACTION:
                ...
                break;
            case Zend_Controller_Plugin_ErrorHandler::EXCEPTION_UNEXPECTED_VALUE:
                $this->view->message = 'Unexpected Value';
                break;           
            case Zend_Controller_Plugin_ErrorHandler::EXCEPTION_MAIL_TRANSPORT:
